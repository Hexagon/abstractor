/***********************************************************************************
    ...
    Communicate with a MySQL server. Query can be passed to both config 
    (query-parameter) or by message topic.
...
class MySQL extends Pipe {
    ...
    invoke(msg) {
        ...
        connection.connect(function(err) {
            ...
            connection.query(self.config.query || msg.topic, msg.parameters, function(err, rows, fields) {
